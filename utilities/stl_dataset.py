...
class STL10_DataManager():
    def __init__(self, dataset_dir = 'datasets/stl10/') -> None:
    ...
    def get_datasets(self, num_users, client_indices=None):
        ...
        train_datasets = {}
        test_datasets  = {}
        template = torchvision.datasets.STL10(root=self.dataset_dir, 
                                            split='test', 
                                            download=False, 
        ...
        print('Done loading STL10')
        return (train_datasets, test_datasets), 10

    def __load_dataset(self):
        train_dataset = torchvision.datasets.STL10(root=self.dataset_dir, 
                                                   split='train', 
                                                   download=True, 
                                                   transform=self.transform)
        test_dataset  = torchvision.datasets.STL10(root=self.dataset_dir, 
                                                   split='test', 
                                                   download=True, 
                                                   transform=self.transform)
